    ...
    <div className="py-10 sm:py-14">
      <PageShell>
        <div className="space-y-8">
          <Reveal className="rounded-[2.4rem] border border-black/5 bg-white/85 p-6 shadow-[0_30px_100px_rgba(15,23,42,0.08)] backdrop-blur-xl dark:border-white/10 dark:bg-white/5 dark:shadow-none sm:p-8">
            <div className="flex flex-wrap items-start justify-between gap-6">
              <div className="max-w-3xl">
                <div className="flex flex-wrap gap-2 text-sm text-zinc-500 dark:text-zinc-400">
                  ...
                  <span className="rounded-full border border-black/8 px-3 py-1 dark:border-white/12">
                    {category?.title ?? word.category}
                  </span>
                </div>

                <h1 className="mt-6 font-serif text-5xl tracking-tight text-zinc-950 dark:text-white sm:text-6xl">
                  {word.word}
                </h1>
                <div
                  lang="ar"
                  dir="rtl"
                  className="arabic-text mt-4 text-3xl font-medium text-zinc-700 dark:text-zinc-200 sm:text-4xl"
                >
            ...
            <div className="mt-10 grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
              <div className="rounded-[1.8rem] bg-zinc-50 p-5 dark:bg-white/6">
                <div className="text-xs font-semibold tracking-[0.2em] text-zinc-400 uppercase dark:text-zinc-500">
                  Arabic definition
                </div>
                <p
                  lang="ar"
                  dir="rtl"
                  className="arabic-text mt-3 text-lg font-medium text-zinc-700 dark:text-zinc-200"
                >
                  {word.arabicDefinition}
                </p>
              </div>
